...
# qhasm: enter chacha_keystream_bytes
.text
.p2align 5
.globl _chacha_keystream_bytes
.globl chacha_keystream_bytes
_chacha_keystream_bytes:
...
# qhasm: enter chacha_xor_bytes
.text
.p2align 5
.globl _chacha_xor_bytes
.globl chacha_xor_bytes
_chacha_xor_bytes:
chacha_xor_bytes:
mov %rsp,%r11
and $31,%r11
...
# asm 2: movq <bytes=%rdx,>bytes_backup=352(%rsp)
movq %rdx,352(%rsp)
...
# asm 2: movq <bytes_backup=352(%rsp),>bytes=%rdx
movq 352(%rsp),%rdx
